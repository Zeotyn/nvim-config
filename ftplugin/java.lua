...
local config = {
  ...
  settings = {
    java = {
      home = '~/.sdkman/candidates/java/17.0.6-tem/',
      eclipse = {
...
local bundles = {
  vim.fn.glob("~/.config/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-0.44.0.jar", 1),
};
